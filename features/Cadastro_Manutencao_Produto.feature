...
And preencher os campos  nome "Camisa Nova", descrição "Algodão", preço "R$50,00", status "Disponível" e categoria "Camisa"
And seleciono a opção "Salvar"
Then eu devo ver uma mensagem de confirmação "Produto cadastrado com sucesso"
And o novo produto com nome "Camisa Nova", descrição "Algodão", preço "R$50,00", status "Disponível" e categoria "Camisa" deve aparecer na lista de produtos cadastrados
...
And alterar os campos nome para "Camisa Azul" e preço para "R$60,00"
And salvar as atualizações
Then eu devo ver uma mensagem de confirmação "Produto atualizado com sucesso"
And as alterações  nome "Camisa Azul" e preço "R$60,00" devem ser refletidas na lista de produtos
