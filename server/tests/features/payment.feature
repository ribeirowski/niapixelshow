Feature: Pagamento
    ...
    Scenario: Marcar o pedido como pago ao confirmar pagamento
        Given o pedido com email "thiagojgcosta@gmail.com", item "Camisa CIN" com descrição "Vermelha, M", quantidade "2", preço "50,00" reais, status "Aguardando Pagamento", criado em "14/05/2024", para o endereço "Rua Altamira, 500" cadastrado
