...
defineFeature(feature, (test) => {
  ...
  test("Criar um novo usuário", ({ given, when, then, and }) => {
    given(
      /^eu tenho dados de usuário válidos com nome "(.*)", telefone "(.*)", email "(.*)", senha "(.*)", endereço "(.*)" e is_admin "false"$/,
    ...
    when(
      /^eu envio uma requisição POST para http:\/\/localhost:3001\/user com os dados do usuário$/,
      async () => {
    ...
    and(
      'a resposta deve conter a mensagem "User created successfully. Verification email sent."',
      () => {
  ...
  test("Criar um usuário com um email existente", ({
    given,
    when,
    then,
    and,
    ...
    given(
      /^já existe um usuário com nome "(.*)", telefone "(.*)", email "(.*)", senha "(.*)", endereço "(.*)" e is_admin "false"$/,
      async (arg0, arg1, arg2, arg3, arg4) => {
        user = {
          name: arg0,
          phone: arg1,
    ...
    given(
      /^eu tenho dados de usuário com nome "(.*)", telefone "(.*)", email "(.*)", senha "(.*)", endereço "(.*)" e is_admin "false"$/,
    ...
    when(
      /^eu envio uma requisição POST para http:\/\/localhost:3001\/user com os dados do novo usuário$/,
      async () => {
        response = await request.post("/user").send(user);
      }
    );
  ...
  test("Atualizar um usuário existente com autenticação", ({
    given,
    when,
    then,
    and,
    ...
    and(
      /^eu tenho dados de atualização de usuário com telefone "(.*)" e endereço "(.*)"$/,
      (arg0, arg1) => {
        user.phone = arg0;
        user.address = arg1;
      }
    ...
    and(
      /^eu estou autenticado com email "(.*)" e senha "(.*)" e tenho um token JWT válido$/,
      async (arg0, arg1) => {
    ...
    when(
      /^eu envio uma requisição PATCH para http:\/\/localhost:3001\/user\/{id} com os novos dados do usuário e o token JWT no cabeçalho$/,
      async () => {
  ...
  test("Atualizar usuário sem autenticação", ({ given, when, then, and }) => {
    ...
    when(
      /^eu envio uma requisição PATCH para http:\/\/localhost:3001\/user\/{id} com os dados do usuário sem autenticação$/,
      async () => {
    ...
    and(
      'a resposta deve conter a mensagem "Authentication token is required"',
      () => {
  ...
  test("Administrador atualiza os detalhes de outro usuário", ({
    given,
    when,
    then,
    and,
    ...
    when(
      /^eu envio uma requisição PATCH para http:\/\/localhost:3001\/user\/{id} com os dados do usuário e o token JWT no cabeçalho$/,
      async () => {
        response = await request
          .patch(`/user/${uid}`)
          .send(user)
  ...
  test("Deletar um usuário como administrador", ({
    given,
    when,
    then,
    and,
    ...
    given(
      /^que existe um usuário com nome "(.*)", telefone "(.*)", email "(.*)", senha "(.*)", endereço "(.*)" e is_admin "false"$/,
      async (arg0, arg1, arg2, arg3, arg4) => {
        user = {
          name: arg0,
          phone: arg1,
    ...
    when(
      /^eu envio uma requisição DELETE para http:\/\/localhost:3001\/user\/{id} com o token JWT no cabeçalho$/,
      async () => {
  ...
  test("Deletar um usuário com autenticação", ({ given, when, then, and }) => {
    ...
    given(
      /^eu estou autenticado como um usuário normal com email "(.*)" e senha "(.*)" e tenho um token JWT válido$/,
      async (arg0, arg1) => {
        await adminAuth.updateUser(uid, { emailVerified: true });
  ...
  test("Deletar um usuário sem privilégios de administrador", ({
    given,
    when,
    then,
    and,
    ...
    when(
      /^eu envio uma requisição DELETE para http:\/\/localhost:3001\/user\/{id}$/,
      async () => {
        response = await request.delete(`/user/${uid}`).set("Cookie", token);
      }
    );
  ...
  test("Ler todos os usuários como administrador", ({
    given,
    when,
    then,
    and,
    ...
    when(
      /^eu envio uma requisição GET para http:\/\/localhost:3001\/user\/all com o token JWT no cabeçalho$/,
      async () => {
  ...
  test("Ler todos os usuários como um usuário normal", ({
    given,
    when,
    then,
    and,
    ...
    and(
      'a resposta deve conter a mensagem "Admin privileges are required"',
      () => {
  ...
  test("Ler um usuário específico", ({ given, when, then, and }) => {
    ...
    when(
      /^eu envio uma requisição GET para http:\/\/localhost:3001\/user\/{id} com o token JWT no cabeçalho$/,
      async () => {
  ...
  test("Login de usuário", ({ given, when, then, and }) => {
    ...
    when(
      /^eu envio uma requisição POST para http:\/\/localhost:3001\/auth\/login com email "(.*)" e senha "(.*)"$/,
      async (arg0, arg1) => {
    ...
    and(
      'a resposta deve conter a mensagem "Login successful" e um token JWT',
      () => {
  ...
  test("Logout de usuário", ({ given, when, then, and }) => {
    ...
    and(
      /^eu estou autenticado com email "(.*)" e senha "(.*)"$/,
      async (arg0, arg1) => {
        const loginResponse = await request.post("/auth/login").send({
          email: arg0,
          password: arg1,
    ...
    when(
      /^eu envio uma requisição POST para http:\/\/localhost:3001\/auth\/logout$/,
      async () => {
