...
defineFeature(feature, (test) => {
  ...
  test("Cadastro do Produto Bem-Sucedido", ({ given, when, then, and }) => {
    ...
    and("que o banco de dados de produto está vazio", async () => {
      ...
      const productVic = await firestoreDB
        .collection("products")
    ...
    when(
      /^o fornecedor submete um formulário de cadastro de produto com nome "(.*)", descrição "(.*)", preço "(.*)", status "(.*)", categoria "(.*)", descrição da categoria "(.*)"$/,
      async (
        name,
        description,
        price,
    ...
    then(
      'o sistema valida que os campos "nome", "descrição", "preço", "status" e "categoria" estão preenchidos',
      () => {
    ...
    and("o sistema verifica que todos os dados estão válidos", () => {
      ...
      expect(response.body.product.category.description).toBe(
        "Descrição da categoria"
      );
    });

    then(
      "o sistema salva o produto no banco de dados e retorna uma confirmação de sucesso",
      () => {
  ...
  test("Cadastro do Produto com Campo Não Preenchido", ({
    given,
    when,
    then,
    and,
    ...
    then(
      'o sistema valida se os campos "nome", "descrição", "preço", "status" e "categoria" estão preenchidos',
      () => {
    ...
    and(
      "o sistema retorna uma mensagem de erro informando que todos os campos devem ser preenchidos",
      () => {
  ...
  test("Cadastro do Produto com Preço Negativo", ({
    given,
    when,
    then,
    and,
    ...
    then(
      'o sistema valida que o campo "preço" possui um valor positivo',
      () => {
    ...
    and(
      'o sistema retorna uma mensagem de erro informando que o "preço" não pode ser negativo',
      () => {
        expect(response.body.message).toBe(
  ...
  test("Atualização do Produto Bem-Sucedida", ({ given, when, then, and }) => {
    ...
    and(
      /^que o produto com ID "(.*)" existe no banco de dados de produto com nome "(.*)", descrição "(.*)", preço "(.*)", status "(.*)", categoria "(.*)", descrição da categoria "(.*)"$/,
      async (
        productId,
        name,
        description,
    ...
    when(
      /^o fornecedor submete um formulário de atualização de produto com nome "(.*)", descrição "(.*)", preço "(.*)", status "(.*)", categoria "(.*)", descrição da categoria "(.*)"$/,
      async (
        name,
        description,
        price,
    ...
    and(
      "o sistema atualiza o produto no banco de dados e retorna uma confirmação de sucesso",
      async () => {
        const updatedProduct = await firestoreDB
          .collection("products")
          .doc("123")
          .get();
  ...
  test("Atualização do Produto com Campo Não Preenchido", ({
    given,
    when,
    then,
    and,
  ...
  test("Atualização do Produto com Preço Negativo", ({
    given,
    when,
    then,
    and,
  ...
  test("Exclusão de Produto Bem-Sucedida", ({ given, when, then, and }) => {
    ...
    and(
      'que o produto com ID "123" existe no banco de dados de produto com nome "Camisa Nova", descrição "Algodão", preço "50", status "true", categoria "Camisas", descrição da categoria "Descrição da categoria"',
      async () => {
        const productData = {
          name: "Camisa Nova",
          description: "Algodão",
    ...
    and(
      "o sistema remove o produto do banco de dados e retorna uma mensagem de confirmação de exclusão",
      async () => {
  ...
  test("Exclusão de Produto Mal-Sucedida", ({ given, when, then, and }) => {
    ...
    when(
      'o fornecedor submete um pedido de exclusão de produto com ID "999"',
      async () => {
        response = await request
          .delete("/product/999")
          .set("Cookie", token)
    ...
    then(
      "o sistema retorna uma mensagem de erro informando que o produto não foi encontrado",
      () => {
  ...
  test("Leitura de Produto Específico Bem-Sucedida", ({
    given,
    when,
    then,
    and,
    ...
    when(
      "o fornecedor solicita os detalhes de um produto específico",
      async () => {
        response = await request
          .get("/product/123")
          .set("Cookie", token)
    ...
    and(
      'o sistema retorna os detalhes do produto solicitado com nome "Camisa Nova", descrição "Algodão", preço "50", status "true", categoria "Camisas", descrição da categoria "Descrição da categoria"',
      async () => {
        expect(response.status).toBe(200);
  ...
  test("Leitura de Produto Mal-Sucedida", ({ given, when, then, and }) => {
    ...
    when(
      'o fornecedor solicita os detalhes de um produto específico com ID "999"',
      async () => {
        response = await request
          .get("/product/999")
          .set("Cookie", token)
  ...
  test("Leitura de Todos os Produtos Bem-Sucedida", ({
    given,
    when,
    then,
    and,
    ...
    and("que existem produtos no banco de dados", async () => {
      ...
      promotions.forEach((promotion) => {
        const promotionRef = firestoreDB
    ...
    then("o sistema retorna a lista de todos os produtos", () => {
      ...
      const product1 = response.body.find(
        (product: Product) => product.name === "Camisa Nova"
      );
      const product2 = response.body.find(
        (product: Product) => product.name === "Calça Jeans"
      );
