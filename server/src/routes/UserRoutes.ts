...
UserRouter.route("/").post(UserController.create); // Permitir que qualquer pessoa crie uma conta

UserRouter.route("/all").get(isAuthenticated, isAdmin, UserController.readAll); // Apenas admin pode ver todos os usuários
