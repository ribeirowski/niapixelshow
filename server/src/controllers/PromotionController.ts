...
class PromotionController {
    async create(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            const productDoc = await firestoreDBTest.collection('products').doc(promotionData.product_id).get();
            if (!productDoc.exists) {
                return res.status(400).json({ message: 'Product not found' });
            }

            // Salva a promoção no Firestore
            await firestoreDBTest.collection('promotions').add(promotionData);
    ...
    async readById(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            const promotionDoc = await firestoreDBTest.collection('promotions').doc(promotionId).get();
    ...
    async readAll(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            const allPromotions = await firestoreDBTest.collection('promotions').get();
    ...
    async update(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            await firestoreDBTest.collection('promotions').doc(promotionId).update(promotionData);
    ...
    async delete(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            await firestoreDBTest.collection('promotions').doc(promotionId).delete();
