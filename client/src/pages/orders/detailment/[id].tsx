            ...
            {orderData && (
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, px: 4, mb: 1 }}>
                    <Box sx={{ textAlign: 'left' }}>
                        <Typography variant="body1" color="secondary" sx={{ fontWeight: 600 }}>Id:</Typography>
                        <Typography variant="body1" color="secondary">{orderData.id}</Typography>
                    </Box>
                    <Box sx={{ textAlign: 'left' }}>
                    ...
                    <Box sx={{ textAlign: 'left' }}>
                        <Typography variant="body1" color="secondary" sx={{ fontWeight: 600 }}>Descrição:</Typography>
                        <Typography variant="body1" color="secondary">{orderData.description}</Typography>
                    </Box>
                    <Box sx={{ textAlign: 'left' }}>
                    ...
                    <Box sx={{ textAlign: 'left' }}>
                        <Typography variant="body1" color="secondary" sx={{ fontWeight: 600 }}>Data:</Typography>
                        <Typography variant="body1" color="secondary">{orderData.date}</Typography>
                    </Box>
                    <Box sx={{ textAlign: 'left' }}>
                        <Typography variant="body1" color="secondary" sx={{ fontWeight: 600 }}>Endereço:</Typography>
                        <Typography variant="body1" color="secondary">{orderData.addr}</Typography>
                    </Box>
                </Box>
            )}
        </Container>
